...
```
node .codex/scripts/google-index.js <url1> [url2] [url3] ...
```
...
```bash
node .codex/scripts/google-index.js https://yourdomain.com/new-article
```

Multiple URLs at once:
```bash
node .codex/scripts/google-index.js \
